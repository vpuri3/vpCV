...
% \include{vpack} % Not needed for this CV and causes package macro conflicts.
...
%\hspace{-0.6em}{Technologies} & \hspace{-0.5em} REST API, Postman, Gmsh, Tableau, PETSc, FFTW\\
