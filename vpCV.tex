...
\begin{itemize}[label=-,leftmargin=1.0em]
    \setlength\itemsep{-0.25em}
%   \setlength{\itemindent}{-1.50em}
    \item Spectral element adjoint optimization code %with overlapping meshes 
...
%   \setlength{\itemindent}{-1.50em}
    ...
    %\item Wrote FORTRAN 77 setup for post-processing and turbulence budgets analysis in Nek5000
\end{itemize}
\vspace{-2.0em}
...
\vspace{0.5em}
%
\textbf{Department of Mechanical Engineering, UIUC} $|$ \textit{Course Assistant}\hfill Jan $2016$--Dec $2017$
