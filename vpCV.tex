...
%   \item Thesis: \textit{Direct Numerical Simulation of Turbulent Flows Over Wavy Walls}
\end{itemize}
\vspace{-2.0em}
...
\begin{itemize}[label=-]
    \setlength\itemsep{-0.25em}
    \setlength{\itemindent}{-1.50em}
    \item \textul{Project}: Wake-recovery past bluff-bodies for Department of Energy \textit{Distributed Wind} project
    \item \textul{Summary}: Conducted Large Eddy Simulations of wind-flow over building-like geometries
    \item \textul{Keywords}: {NEK5000}, {Gmsh}, Reynolds stress budgets, synthetic turbulence generation
\end{itemize}
\vspace{-2.0em}
...
\begin{itemize}[label=-]
    \setlength\itemsep{-0.25em}
    \setlength{\itemindent}{-1.50em}
    \item \textul{Project}: Direct Numerical Simulations for Department of Energy \textit{Offshore Wind} project
    \item \textul{Summary}: Analyzed Reynolds stress budgets in canonical flows for turbulence model development
    \item \textul{Keywords}: {NEK5000}, meshing, post-processing, turbulence modelling
\end{itemize}
\vspace{-2.0em}
...
\begin{itemize}[label=-]
    ...
    \item \textul{Keywords}: {Einstein Toolkit}, {PETSc}, {FFTW}, preconditioning, {Scheduled Relaxation Jacobi}
