...
%\textbf{University of Illinois Urbana-Champaign} \hfill Aug $2020$--Present
%
%\vspace{-1.75em}
%\begin{itemize}[label= ]
%    \setlength\itemsep{-0.25em}
%    \item {\sl M.S. Mathematics} \hfill %GPA: $3.66/4.00$
%    \item {\sl Research Assistant} under Dr. Anil Hirani studying Discrete Exterior Calculus
%\end{itemize}
%\vspace{-2.0em}
%
...
\begin{itemize}[label=-]
    \setlength\itemsep{-0.25em}
%   \item Created instructional demonstrations for Theoretical \& Applied Mechanics courses serving $2500$ students
