...
\cvsection{Summary}
Designs transformer architectures with explicit attention to scaling, memory, and communication structure.
Developed FLARE, enabling million-token regimes on a single GPU.
Implements new architectures in PyTorch and Triton.
Background spans high-performance computing, numerical analysis, and computational fluid dynamics.
...
\begin{itemize}[leftmargin=1.45em,labelindent=0.45em]
  \item Reduced memory from $\mathcal{O}(N^2)$ to $\mathcal{O}(NM)$.
