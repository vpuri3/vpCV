...
\begin{itemize}[label=-,leftmargin=1.0em]
    ...
    \item Developing numerical PDE solvers that utilize differentiable programming for adjoint optimization
\end{itemize}
\vspace{-2.0em}
...
%   \setlength{\itemindent}{-1.50em}
    ...
    \item Mesh generation, setup, and analysis of OpenFOAM, \textsc{Nek5000} simulations
