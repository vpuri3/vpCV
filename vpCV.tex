...
\cvsection{Objective}
PhD candidate graduating August 2026 seeking a technical role in machine learning research.
Experience developing scalable-transformers and custom GPU kernels for large-scale training.
...
\begin{itemize}[leftmargin=1.45em,labelindent=0.45em]
  ...
  \item Integrated into NVIDIA PhysicsNeMo as an experimental model for scientific machine learning workloads.
\end{itemize}
...
\cvrole{Equation-based PDE modeling with neural manifolds}{Hybrid data + physics methods}{2024}
\begin{itemize}[leftmargin=1.45em,labelindent=0.45em]
...
\begin{itemize}[leftmargin=1.45em,labelindent=0.45em]
  ...
  \item Wrote solvers for phase field simulations of lithium dendritic growth in solid-state batteries.
  \item Wrote fluids dynamics solvers for turbulence closure modeling with differentiable physics.
\end{itemize}
%
...
\textbf{Puri, V}. et al., \textit{FLARE Decoder: Low-rank attention routing for causal language modeling} (In preparation).
...
\textbf{Puri, V}. et al., \textit{Reduced order modeling with smooth neural fields}. JCP 2025, \href{https://doi.org/10.1016/j.jcp.2025.113957}{doi:10.1016/j.jcp.2025.113957}.
...
\cvskill{ML Architectures}{Efficient attention, causal transformers, memory-efficient prefill/decode, neural operators.}

\cvskill{ML Systems}{PyTorch internals, distributed training, mixed-precision training, Hugging Face.}

\cvskill{GPU \& Systems}{Triton kernel development, FlashAttention-style block algorithms, online softmax, Nsight profiling.}

\cvskill{Scientific Foundations}{Numerical linear algebra, PDE-constrained modeling, finite elements, spectral methods.}
